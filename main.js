...
app.controller("cardController", function($timeout) {
  ...
  self.cardList = [
    "images/biff.jpg",
    "images/delorean.jpg",
    "images/emmettbrown.jpg",
    "images/fluxcapacitor.png",
    "images/george.jpg",
    "images/greatscott.jpg",
    "images/lorraine.jpg",
    "images/marty.jpg",
    "images/timecircuit.jpg",
    "images/delorean2.jpg",
    "images/bttf2.jpg",
    "images/bttf3.jpg"
  ];
  ...
  self.getAccuracy = function() {
    self.accuracy =
      Math.floor((self.totalMatches / self.totalAttempts) * 100) + "%";
  };
